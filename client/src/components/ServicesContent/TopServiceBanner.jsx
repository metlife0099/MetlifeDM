...
const TopServicesBanner = () => {
  const services = [
    { name: "Web Development", icon: <FaServer className="!text-2xl" /> },
    { name: "SEO Optimization", icon: <FaSearchDollar className="!text-2xl" /> },
    { name: "Google Ads", icon: <FaAd className="!text-2xl" /> },
    { name: "PPC Campaigns", icon: <FaChartLine className="!text-2xl" /> },
    { name: "Social Media", icon: <FaHashtag className="!text-2xl" /> },
    { name: "Email Marketing", icon: <FaMailBulk className="!text-2xl" /> },
      ...
      <div className="!max-w-7xl !mx-auto !relative !z-10">
        ...
        >
          ...
          <p className="!text-xl !text-blue-100 !max-w-3xl !mx-auto">
            Our most popular services trusted by 500+ businesses to increase visibility, engagement, and revenue
          </p>
        </motion.div>
...
export default TopServicesBanner;